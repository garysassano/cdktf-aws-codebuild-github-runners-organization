...
export class MyStack extends TerraformStack {
  constructor(scope: Construct, id: string) {
    ...
    // GitHub workflow in JSON format
    const jsonGithubWorkflow = {
      name: "Hello World",
      on: {
        workflow_dispatch: {},
      },
    ...
    // Add GitHub workflow file to repository
    new RepositoryFile(this, "GithubWorkflowFile", {
      repository: sampleRepo.name,
      file: Fn.rawString(".github/workflows/hello-world.yml"),
      content: YAML.stringify(jsonGithubWorkflow),
      commitMessage: "Add GitHub workflow file",
    });
  }
}
